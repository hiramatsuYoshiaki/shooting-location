...
@Component({
  selector: 'app-category-spot-marker',
  templateUrl: './category-spot-marker.component.html',
  styleUrls: ['./category-spot-marker.component.scss']
})
export class CategorySpotMarkerComponent implements OnInit {
